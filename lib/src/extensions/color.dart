...
extension ColorExtension on Color {
  ...
  /// Is this color is a light or dark one.
  bool isLight() => computeLuminance() > 0.179;
  ...
  static Color fromRGBHexString(String hexString) {
    if (hexString.length == 3 || hexString.length == 4) {
      ...
      throw Exception('Invalid format for RGB hex string: $hexString');
    }
  }
  ...
  static Color fromARGBHexString(String hexString) {
    if (hexString.length == 4 || hexString.length == 5) {
      ...
      throw Exception('Invalid format for ARGB hex string: $hexString');
    }
  }
